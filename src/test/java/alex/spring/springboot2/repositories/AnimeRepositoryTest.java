...
class AnimeRepositoryTest {
    ...
    void findByName_ReturnsEmptyList_WhenAnimeIsNotFound() {
        List<Anime> animes = this.animeRepository.findByName("testest");
    ...
    @Test
    @DisplayName("Save throw ConstraintViolationException whe name is empty and blank")
    void save_ThrowsConstraintViolationException_WhenNameIsEmptyOrBlank() {
